...
class _MapScreenState extends ConsumerState<MapScreen> with TickerProviderStateMixin {
  ...
  final List<_MapPOI> _casaPOIs = const [
    _MapPOI(id: 'hotel_casa_001', name: 'Four Seasons Casablanca', category: 'Hôtels', location: 'Corniche, Anfa', rating: 4.9, price: '400€/nuit', lat: 33.5890, lng: -7.6650, icon: Icons.hotel_rounded, route: '/hotel/hotel_casa_001', images: ['assets/images/casablanca/hotels/four_seasons_casa/1.png','assets/images/casablanca/hotels/four_seasons_casa/2.png','assets/images/casablanca/hotels/four_seasons_casa/3.png']),
    _MapPOI(id: 'hotel_casa_002', name: 'Hôtel Le Doge', category: 'Hôtels', location: 'Rue du Docteur Veyre', rating: 4.8, price: '220€/nuit', lat: 33.5920, lng: -7.6200, icon: Icons.hotel_rounded, route: '/hotel/hotel_casa_002', images: ['assets/images/casablanca/hotels/le_doge_casa/1.png','assets/images/casablanca/hotels/le_doge_casa/2.png','assets/images/casablanca/hotels/le_doge_casa/3.png']),
    _MapPOI(id: 'hotel_casa_003', name: 'Hyatt Regency', category: 'Hôtels', location: 'Place des Nations Unies', rating: 4.7, price: '180€/nuit', lat: 33.5980, lng: -7.6170, icon: Icons.hotel_rounded, route: '/hotel/hotel_casa_003', images: ['assets/images/casablanca/hotels/hyatt_casa/1.png','assets/images/casablanca/hotels/hyatt_casa/2.png','assets/images/casablanca/hotels/hyatt_casa/3.png']),
    _MapPOI(id: 'hotel_casa_004', name: 'Kenzi Tower', category: 'Hôtels', location: 'Twin Center, Maarif', rating: 4.6, price: '150€/nuit', lat: 33.5830, lng: -7.6310, icon: Icons.hotel_rounded, route: '/hotel/hotel_casa_004', images: ['assets/images/casablanca/hotels/kenzi_tower/1.png','assets/images/casablanca/hotels/kenzi_tower/2.png','assets/images/casablanca/hotels/kenzi_tower/3.png']),
    _MapPOI(id: 'resto_casa_001', name: 'Rick\'s Café', category: 'Restaurants', location: 'Ancienne Médina', rating: 4.7, price: '40€/moy', lat: 33.6030, lng: -7.6130, icon: Icons.restaurant_rounded, route: '/restaurant/resto_casa_001', images: ['assets/images/casablanca/restaurants/ricks_cafe/1.png','assets/images/casablanca/restaurants/ricks_cafe/2.png','assets/images/casablanca/restaurants/ricks_cafe/3.png']),
    _MapPOI(id: 'resto_casa_002', name: 'La Sqala', category: 'Restaurants', location: 'Bd des Almohades', rating: 4.8, price: '25€/moy', lat: 33.6040, lng: -7.6160, icon: Icons.restaurant_rounded, route: '/restaurant/resto_casa_002', images: ['assets/images/casablanca/restaurants/la_sqala/1.png','assets/images/casablanca/restaurants/la_sqala/2.png','assets/images/casablanca/restaurants/la_sqala/3.png']),
    _MapPOI(id: 'resto_casa_003', name: 'Le Cabestan', category: 'Restaurants', location: 'Corniche, Ain Diab', rating: 4.9, price: '50€/moy', lat: 33.5870, lng: -7.6700, icon: Icons.restaurant_rounded, route: '/restaurant/resto_casa_003', images: ['assets/images/casablanca/restaurants/le_cabestan/1.png','assets/images/casablanca/restaurants/le_cabestan/2.png','assets/images/casablanca/restaurants/le_cabestan/3.png']),
    _MapPOI(id: 'resto_casa_005', name: 'La Bodega', category: 'Restaurants', location: 'Rue Allal Ben Abdellah', rating: 4.6, price: '30€/moy', lat: 33.5940, lng: -7.6180, icon: Icons.restaurant_rounded, route: '/restaurant/resto_casa_005', images: ['assets/images/casablanca/restaurants/la_bodega/1.png','assets/images/casablanca/restaurants/la_bodega/2.png','assets/images/casablanca/restaurants/la_bodega/3.png']),
    _MapPOI(id: 'exp_casa_001', name: 'Mosquée Hassan II', category: 'Expériences', location: 'Bd de la Corniche', rating: 4.9, price: '12€/pers', lat: 33.6086, lng: -7.6327, icon: Icons.explore_rounded, route: '/experience/exp_casa_001', images: ['assets/images/casablanca/experiences/mosquee_hassan/1.png','assets/images/casablanca/experiences/mosquee_hassan/2.png','assets/images/casablanca/experiences/mosquee_hassan/3.png']),
    _MapPOI(id: 'exp_casa_002', name: 'Corniche Ain Diab', category: 'Expériences', location: 'Ain Diab', rating: 4.6, price: 'Gratuit', lat: 33.5880, lng: -7.6680, icon: Icons.explore_rounded, route: '/experience/exp_casa_002', images: ['assets/images/casablanca/experiences/corniche_casa/1.png','assets/images/casablanca/experiences/corniche_casa/2.png','assets/images/casablanca/experiences/corniche_casa/3.png']),
    _MapPOI(id: 'exp_casa_003', name: 'Ancienne Médina', category: 'Expériences', location: 'Ancienne Médina', rating: 4.7, price: '25€/pers', lat: 33.6020, lng: -7.6120, icon: Icons.explore_rounded, route: '/experience/exp_casa_003', images: ['assets/images/casablanca/experiences/medina_casa/1.png','assets/images/casablanca/experiences/medina_casa/2.png','assets/images/casablanca/experiences/medina_casa/3.png']),
    ...
    _MapPOI(id: 'boutique_casa_001', name: 'Derb Ghallef Vintage', category: 'Boutiques', location: 'Derb Ghallef', rating: 4.5, price: '20-300 DH', lat: 33.5760, lng: -7.6250, icon: Icons.storefront_rounded, route: '/boutique/boutique_casa_001', images: ['assets/images/casablanca/boutiques/derb_ghallef/1.png','assets/images/casablanca/boutiques/derb_ghallef/2.png','assets/images/casablanca/boutiques/derb_ghallef/3.png']),
    _MapPOI(id: 'boutique_casa_002', name: 'Quartier Habous Artisanat', category: 'Boutiques', location: 'Quartier Habous', rating: 4.8, price: '30-500 DH', lat: 33.5800, lng: -7.6100, icon: Icons.storefront_rounded, route: '/boutique/boutique_casa_002', images: ['assets/images/casablanca/boutiques/habous_artisanat/1.png','assets/images/casablanca/boutiques/habous_artisanat/2.png','assets/images/casablanca/boutiques/habous_artisanat/3.png']),
    _MapPOI(id: 'boutique_casa_003', name: 'Trésor des Arts Marocains', category: 'Boutiques', location: 'Rue Mohammed V', rating: 4.7, price: '50-1500 DH', lat: 33.5960, lng: -7.6190, icon: Icons.storefront_rounded, route: '/boutique/boutique_casa_003', images: ['assets/images/casablanca/boutiques/tresor_arts/1.png','assets/images/casablanca/boutiques/tresor_arts/2.png','assets/images/casablanca/boutiques/tresor_arts/3.png']),
    _MapPOI(id: 'boutique_casa_006', name: 'Atelier Zellige Casa', category: 'Boutiques', location: 'Aïn Sebaâ', rating: 4.9, price: '30-800 DH', lat: 33.6100, lng: -7.5750, icon: Icons.storefront_rounded, route: '/boutique/boutique_casa_006', images: ['assets/images/casablanca/boutiques/atelier_zellige/1.png','assets/images/casablanca/boutiques/atelier_zellige/2.png','assets/images/casablanca/boutiques/atelier_zellige/3.png']),
  ];
