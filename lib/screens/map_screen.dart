...
class _MapScreenState extends State<MapScreen> with TickerProviderStateMixin {
  ...
  static final _center = LatLng(31.6295, -7.9811);

  final List<_MapPOI> _allPOIs = const [
    // Hotels
    _MapPOI(id: 'hotel_002', name: 'La Mamounia', category: 'Hôtels', location: 'Hivernage', rating: 4.9, price: '350€/nuit', lat: 31.6218, lng: -7.9973, icon: Icons.hotel_rounded, route: '/hotel/hotel_002', images: ['assets/images/hotels/la_mamounia/1.png','assets/images/hotels/la_mamounia/2.png','assets/images/hotels/la_mamounia/3.png']),
    _MapPOI(id: 'hotel_003', name: 'Riad Yasmine', category: 'Hôtels', location: 'Médina', rating: 4.6, price: '95€/nuit', lat: 31.6310, lng: -7.9870, icon: Icons.hotel_rounded, route: '/hotel/hotel_003', images: ['assets/images/hotels/riad_yasmine/1.png','assets/images/hotels/riad_yasmine/2.png','assets/images/hotels/riad_yasmine/3.png']),
    _MapPOI(id: 'hotel_005', name: 'La Sultana', category: 'Hôtels', location: 'Kasbah', rating: 4.8, price: '280€/nuit', lat: 31.6175, lng: -7.9895, icon: Icons.hotel_rounded, route: '/hotel/hotel_005', images: ['assets/images/hotels/la_sultana/1.png','assets/images/hotels/la_sultana/2.png','assets/images/hotels/la_sultana/3.png']),
    _MapPOI(id: 'hotel_006', name: 'Mandarin Oriental', category: 'Hôtels', location: 'Palmeraie', rating: 4.9, price: '420€/nuit', lat: 31.6680, lng: -8.0050, icon: Icons.hotel_rounded, route: '/hotel/hotel_006', images: ['assets/images/hotels/mandarin_oriental/1.png','assets/images/hotels/mandarin_oriental/2.png','assets/images/hotels/mandarin_oriental/3.png']),
    _MapPOI(id: 'hotel_007', name: 'Riad Kniza', category: 'Hôtels', location: 'Médina', rating: 4.7, price: '200€/nuit', lat: 31.6280, lng: -7.9880, icon: Icons.hotel_rounded, route: '/hotel/hotel_007', images: ['assets/images/hotels/riad_kniza/1.png','assets/images/hotels/riad_kniza/2.png','assets/images/hotels/riad_kniza/3.png']),
    _MapPOI(id: 'hotel_008', name: 'Royal Mansour', category: 'Hôtels', location: 'Médina', rating: 4.9, price: '550€/nuit', lat: 31.6230, lng: -7.9930, icon: Icons.hotel_rounded, route: '/hotel/hotel_008', images: ['assets/images/hotels/royal_mansour/1.png','assets/images/hotels/royal_mansour/2.png','assets/images/hotels/royal_mansour/3.png']),
    // Restaurants
    _MapPOI(id: 'resto_001', name: 'Le Jardin', category: 'Restaurants', location: 'Souk Sidi Abdelaziz, Médina', rating: 4.7, price: '25€/moy', lat: 31.6325, lng: -7.9855, icon: Icons.restaurant_rounded, route: '/restaurant/resto_001', images: ['assets/images/restaurants/le_jardin/1.png','assets/images/restaurants/le_jardin/2.png','assets/images/restaurants/le_jardin/3.png']),
    _MapPOI(id: 'resto_002', name: 'Nomad', category: 'Restaurants', location: 'Derb Aarjan, Médina', rating: 4.8, price: '30€/moy', lat: 31.6290, lng: -7.9860, icon: Icons.restaurant_rounded, route: '/restaurant/resto_002', images: ['assets/images/restaurants/nomad/1.png','assets/images/restaurants/nomad/2.png','assets/images/restaurants/nomad/3.png']),
    _MapPOI(id: 'resto_003', name: 'Al Fassia', category: 'Restaurants', location: 'Guéliz, Marrakech', rating: 4.9, price: '35€/moy', lat: 31.6370, lng: -8.0060, icon: Icons.restaurant_rounded, route: '/restaurant/resto_003', images: ['assets/images/restaurants/al_fassia/1.png','assets/images/restaurants/al_fassia/2.png','assets/images/restaurants/al_fassia/3.png']),
    _MapPOI(id: 'resto_004', name: 'CAFE CLOCK', category: 'Restaurants', location: 'Derb Chtouka, Kasbah', rating: 4.5, price: '12€/moy', lat: 31.6180, lng: -7.9910, icon: Icons.restaurant_rounded, route: '/restaurant/resto_004', images: ['assets/images/restaurants/cafe_clock/1.png','assets/images/restaurants/cafe_clock/2.png','assets/images/restaurants/cafe_clock/3.png']),
    _MapPOI(id: 'resto_005', name: 'La Table du Palais', category: 'Restaurants', location: 'Royal Mansour, Médina', rating: 4.9, price: '120€/moy', lat: 31.6235, lng: -7.9925, icon: Icons.restaurant_rounded, route: '/restaurant/resto_005', images: ['assets/images/restaurants/la_table_du_palais/1.png','assets/images/restaurants/la_table_du_palais/2.png','assets/images/restaurants/la_table_du_palais/3.png']),
    _MapPOI(id: 'resto_006', name: 'Chez Lamine Hadj Mustapha', category: 'Restaurants', location: 'Place Jemaa el-Fna', rating: 4.6, price: '8€/moy', lat: 31.6258, lng: -7.9891, icon: Icons.restaurant_rounded, route: '/restaurant/resto_006', images: ['assets/images/restaurants/chez_lamine/1.png','assets/images/restaurants/chez_lamine/2.png','assets/images/restaurants/chez_lamine/3.png']),
    // Experiences
    _MapPOI(id: 'exp_001', name: 'Safari dans le Désert d\'Agafay', category: 'Expériences', location: 'Désert d\'Agafay, Marrakech', rating: 4.8, price: '85€/pers', lat: 31.4950, lng: -8.1350, icon: Icons.explore_rounded, route: '/experience/exp_001', images: ['assets/images/experiences/safari_agafay/1.png','assets/images/experiences/safari_agafay/2.png','assets/images/experiences/safari_agafay/3.png']),
    _MapPOI(id: 'exp_002', name: 'Visite Guidée de la Médina', category: 'Expériences', location: 'Médina, Marrakech', rating: 4.7, price: '35€/pers', lat: 31.6300, lng: -7.9865, icon: Icons.explore_rounded, route: '/experience/exp_002', images: ['assets/images/experiences/medina_visite/1.png','assets/images/experiences/medina_visite/2.png','assets/images/experiences/medina_visite/3.png']),
    _MapPOI(id: 'exp_003', name: 'Randonnée dans l\'Atlas', category: 'Expériences', location: 'Vallée de l\'Ourika', rating: 4.9, price: '60€/pers', lat: 31.3500, lng: -7.8500, icon: Icons.explore_rounded, route: '/experience/exp_003', images: ['assets/images/experiences/randonnee_atlas/1.png','assets/images/experiences/randonnee_atlas/2.png','assets/images/experiences/randonnee_atlas/3.png']),
    _MapPOI(id: 'exp_004', name: 'Cours de Cuisine Marocaine', category: 'Expériences', location: 'Riad Cooking, Médina', rating: 4.8, price: '50€/pers', lat: 31.6315, lng: -7.9875, icon: Icons.explore_rounded, route: '/experience/exp_004', images: ['assets/images/experiences/cours_cuisine/1.png','assets/images/experiences/cours_cuisine/2.png','assets/images/experiences/cours_cuisine/3.png']),
    _MapPOI(id: 'exp_005', name: 'Vol en Montgolfière', category: 'Expériences', location: 'Palmeraie, Marrakech', rating: 4.9, price: '180€/pers', lat: 31.6700, lng: -8.0100, icon: Icons.explore_rounded, route: '/experience/exp_005', images: ['assets/images/experiences/vol_montgolfiere/1.png','assets/images/experiences/vol_montgolfiere/2.png','assets/images/experiences/vol_montgolfiere/3.png']),
    _MapPOI(id: 'exp_006', name: 'Jardin Majorelle & YSL', category: 'Expériences', location: 'Guéliz, Marrakech', rating: 4.7, price: '15€/pers', lat: 31.6418, lng: -8.0033, icon: Icons.explore_rounded, route: '/experience/exp_006', images: ['assets/images/experiences/jardin_majorelle/1.png','assets/images/experiences/jardin_majorelle/2.png','assets/images/experiences/jardin_majorelle/3.png']),
    // Boutiques
    _MapPOI(id: 'boutique_001', name: 'Tapis Berbères El Badi', category: 'Boutiques', location: 'Souk des Tapis, Médina', rating: 4.8, price: '150-2000 DH', lat: 31.6320, lng: -7.9850, icon: Icons.storefront_rounded, route: '/boutique/boutique_001', images: ['assets/images/boutiques/tapis_berberes/1.png','assets/images/boutiques/tapis_berberes/2.png','assets/images/boutiques/tapis_berberes/3.png']),
    _MapPOI(id: 'boutique_002', name: 'Atelier Céramique Safi', category: 'Boutiques', location: 'Derb Dabachi, Médina', rating: 4.7, price: '20-300 DH', lat: 31.6305, lng: -7.9845, icon: Icons.storefront_rounded, route: '/boutique/boutique_002', images: ['assets/images/boutiques/ceramique_safi/1.png','assets/images/boutiques/ceramique_safi/2.png','assets/images/boutiques/ceramique_safi/3.png']),
    _MapPOI(id: 'boutique_003', name: 'Maroquinerie Artisanale Youssef', category: 'Boutiques', location: 'Souk Cherratine, Médina', rating: 4.6, price: '30-500 DH', lat: 31.6335, lng: -7.9840, icon: Icons.storefront_rounded, route: '/boutique/boutique_003', images: ['assets/images/boutiques/maroquinerie_youssef/1.png','assets/images/boutiques/maroquinerie_youssef/2.png','assets/images/boutiques/maroquinerie_youssef/3.png']),
    _MapPOI(id: 'boutique_004', name: 'Bijoux Touareg Amina', category: 'Boutiques', location: 'Place des Ferblantiers', rating: 4.9, price: '50-800 DH', lat: 31.6195, lng: -7.9885, icon: Icons.storefront_rounded, route: '/boutique/boutique_004', images: ['assets/images/boutiques/bijoux_touareg/1.png','assets/images/boutiques/bijoux_touareg/2.png','assets/images/boutiques/bijoux_touareg/3.png']),
    _MapPOI(id: 'boutique_005', name: 'Tissages Tradition Amazigh', category: 'Boutiques', location: 'Souk Haddadine, Médina', rating: 4.7, price: '40-600 DH', lat: 31.6330, lng: -7.9835, icon: Icons.storefront_rounded, route: '/boutique/boutique_005', images: ['assets/images/boutiques/tissages_amazigh/1.png','assets/images/boutiques/tissages_amazigh/2.png','assets/images/boutiques/tissages_amazigh/3.png']),
    _MapPOI(id: 'boutique_006', name: 'Poterie d\'Art Tamegroute', category: 'Boutiques', location: 'Quartier des Potiers', rating: 4.5, price: '15-200 DH', lat: 31.6285, lng: -7.9900, icon: Icons.storefront_rounded, route: '/boutique/boutique_006', images: ['assets/images/boutiques/poterie_tamegroute/1.png','assets/images/boutiques/poterie_tamegroute/2.png','assets/images/boutiques/poterie_tamegroute/3.png']),
  ];
  ...
  List<_MapPOI> get _filtered {
    if (_selectedFilter == 0) return _allPOIs;
    return _allPOIs.where((p) => p.category == _filters[_selectedFilter].label).toList();
  }
    ...
    return Scaffold(
      ...
      body: Stack(children: [
        ...
        Positioned(top: 0, left: 0, right: 0, child: SafeArea(child: Padding(padding: const EdgeInsets.fromLTRB(20, 8, 20, 0), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text('Marrakech · ${_filtered.length} lieux', style: TextStyle(fontFamily: 'DarkerGrotesque', color: Colors.white.withValues(alpha: 0.5), fontSize: 14)),
        ])))),
        // Filters
