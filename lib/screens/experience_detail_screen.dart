...
class _ExperienceDetailScreenState extends State<ExperienceDetailScreen> {
  ...
  static const _expDataMap = {
    ...
    'exp_casa_001': _ExpInfo(
      name: 'Visite de la Mosquée Hassan II', location: 'Boulevard de la Corniche, Casablanca',
      rating: 4.9, reviews: 1245,
      description: 'Découvrez la plus grande mosquée d\'Afrique et la 3e au monde. Chef-d\'œuvre architectural avec son minaret de 210m, son toit ouvrant et ses sols en marbre. Visite guidée à travers les salles de prière, les hammams et les jardins.',
      imageUrl: 'assets/images/casablanca/experiences/mosquee_hassan/1.png',
      images: ['assets/images/casablanca/experiences/mosquee_hassan/1.png', 'assets/images/casablanca/experiences/mosquee_hassan/2.png', 'assets/images/casablanca/experiences/mosquee_hassan/3.png'],
      price: 12, duree: '2h', capacite: 30, category: 'Culture',
    ),
    'exp_casa_002': _ExpInfo(
      name: 'Promenade Corniche Ain Diab', location: 'Ain Diab, Casablanca',
      rating: 4.6, reviews: 678,
      description: 'Flânez le long de la célèbre Corniche de Casablanca. Plages, piscines, restaurants en bord de mer et coucher de soleil spectaculaire sur l\'Atlantique. L\'endroit préféré des Casablancais pour se détendre.',
      imageUrl: 'assets/images/casablanca/experiences/corniche_casa/1.png',
      images: ['assets/images/casablanca/experiences/corniche_casa/1.png', 'assets/images/casablanca/experiences/corniche_casa/2.png', 'assets/images/casablanca/experiences/corniche_casa/3.png'],
      price: 0, duree: '3h', capacite: 20, category: 'Nature',
    ),
    'exp_casa_003': _ExpInfo(
      name: 'Tour de l\'Ancienne Médina', location: 'Ancienne Médina, Casablanca',
      rating: 4.7, reviews: 423,
      description: 'Explorez l\'ancienne médina de Casablanca avec un guide local. Marchés colorés, architecture traditionnelle et ambiance authentique au cœur de la ville blanche.',
      imageUrl: 'assets/images/casablanca/experiences/medina_casa/1.png',
      images: ['assets/images/casablanca/experiences/medina_casa/1.png', 'assets/images/casablanca/experiences/medina_casa/2.png', 'assets/images/casablanca/experiences/medina_casa/3.png'],
      price: 25, duree: '3h', capacite: 15, category: 'Culture',
    ),
